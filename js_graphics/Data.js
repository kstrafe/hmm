...
var all_bubbles = {
    ...
    56: {
        x: 1191.8916542226684,
        y: -13999.663265306113,
        r: 60,
        link: [],
        title: "Not equal",
        facts: "The following sign means not equal:\n$$\\neq$$\nBy using this sign we can express that two number or expressions is not the same.\n$$1 \\neq 2$$\n$$ x \\neq x + 1$$\n",
    },
    57: {
        x: 983.8916542226689,
        y: -13810.329931972781,
        r: 60,
        link: [],
